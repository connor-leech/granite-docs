...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" iconType="regular" color="#000000" href="https://huggingface.co/ibm-granite/granite-3b-code-instruct-128k/tree/main" cta="Model card">
